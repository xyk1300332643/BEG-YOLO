...
def get_params():
    params = {
        'weight': r'D:\PyCharm 2021.1.3.rar.baiduyun.p\workspace\yolov8\ultralytics-main\runs\detect\train5\weights\best.pt',
        # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        'method': 'GradCAM',
        # HiResCAM,GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM
        'layer': [22,24,28,31,35],  # [22,24,28,31,35]#[27, 31, 35] [10, 12, 16]
...
if __name__ == '__main__':
    ...
    model(r'D:\PyCharm 2021.1.3.rar.baiduyun.p\workspace\yolov8\ultralytics-main\NEU-DET\train\images\scratches_16.jpg',
          'result')
